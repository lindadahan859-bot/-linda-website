document.addEventListener('DOMContentLoaded',function(){
  ...
  function addFloatingButtons(){
    ...
    w.target='_blank';w.rel='noopener';w.setAttribute('aria-label','WhatsApp');
    w.innerHTML='<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16.02 3.2c-7.02 0-12.73 5.7-12.73 12.71 0 2.25.59 4.45 1.72 6.39L3.2 28.8l6.66-1.75c1.87 1.02 3.98 1.56 6.16 1.56h.01c7.01 0 12.71-5.7 12.72-12.71 0-3.4-1.32-6.59-3.72-8.99A12.63 12.63 0 0 0 16.02 3.2Zm0 23.26h-.01c-1.94 0-3.84-.52-5.5-1.51l-.39-.23-3.95 1.04 1.05-3.85-.25-.4a10.48 10.48 0 0 1-1.61-5.6c0-5.85 4.77-10.6 10.64-10.6 2.84 0 5.51 1.11 7.52 3.12a10.55 10.55 0 0 1 3.12 7.48c0 5.85-4.77 10.61-10.62 10.61Zm5.82-7.94c-.32-.16-1.88-.93-2.17-1.04-.29-.11-.5-.16-.71.16-.21.32-.82 1.04-1 1.25-.18.21-.37.24-.69.08-.32-.16-1.35-.5-2.57-1.59-.95-.85-1.59-1.9-1.78-2.22-.18-.32-.02-.49.14-.65.14-.14.32-.37.48-.55.16-.18.21-.32.32-.53.11-.21.05-.4-.03-.56-.08-.16-.71-1.72-.98-2.35-.26-.62-.52-.54-.71-.55h-.61c-.21 0-.56.08-.85.4-.29.32-1.11 1.09-1.11 2.65s1.14 3.08 1.3 3.29c.16.21 2.24 3.42 5.42 4.79.76.33 1.35.52 1.81.67.76.24 1.45.21 2 .13.61-.09 1.88-.77 2.14-1.51.26-.74.26-1.38.18-1.51-.08-.13-.29-.21-.61-.37Z"/></svg>';
